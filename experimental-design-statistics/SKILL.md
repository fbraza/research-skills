...
**Design review protocol:** Before analyzing any new dataset, review the experimental design using the checklist in [references/design_review_protocol.md](references/design_review_protocol.md). Returns a verdict (APPROVED / CONDITIONAL / REJECTED) with actionable findings.
