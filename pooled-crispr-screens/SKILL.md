...
⚠️ **MANDATORY:** Read these know-how guides before running any analysis:
- `skills/knowhows/KH_data_analysis_best_practices.md` — data validation, duplicate handling, missing data
- `skills/knowhows/KH_gene_essentiality.md` — DepMap score direction (negative = essential), mandatory inversion before correlation
