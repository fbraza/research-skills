---
id: scvi-tools
name: scvi-tools Advanced Single-Cell Probabilistic Models
description: >
  Advanced probabilistic modeling for single-cell omics with scvi-tools.
  Use for multimodal integration (TOTALVI for CITE-seq RNA+protein, MultiVI for
  multiome RNA+ATAC), semi-supervised cell type annotation with uncertainty (scANVI),
  Bayesian differential expression with posterior uncertainty, probabilistic RNA velocity
  (VeloVI), and custom generative models.
  Trigger phrases: "TOTALVI", "CITE-seq integration", "MultiVI", "multiome RNA ATAC",
  "scANVI", "cell type annotation uncertainty", "Bayesian differential expression",
  "scvi-tools", "VeloVI", "probabilistic single-cell", "scVI custom model",
  "contrastiveVI", "perturbation effect scRNA", "spatial deconvolution scVI".
  Do NOT use for standard scRNA-seq batch correction — use `scrnaseq-scanpy-core-analysis`
  which has `scripts/integrate_scvi.py` for that. Do NOT use for standard KM/Cox survival
  (use survival-analysis-clinical). Do NOT use for trajectory inference (use
  scrna-trajectory-inference).
category: transcriptomics
short-description: "scvi-tools advanced models — TOTALVI, MultiVI, scANVI, Bayesian DE, VeloVI."
detailed-description: "Probabilistic single-cell models beyond standard batch correction: TOTALVI (CITE-seq RNA+protein), MultiVI (multiome RNA+ATAC), scANVI (semi-supervised cell type annotation with uncertainty), Bayesian DE with posterior credible intervals, VeloVI (RNA velocity with uncertainty), contrastiveVI (perturbation isolation), spatial deconvolution. Reference docs cover each model family. See references/workflows.md for end-to-end pipelines."
