...
- Apply year filters for recent evidence (add year range to query)
...
- Always retrieve and read at least 5-10 papers for any substantive claim
...
Prefer PubMed (pubmed.ncbi.nlm.nih.gov) and bioRxiv for scientific literature
